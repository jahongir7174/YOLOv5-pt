...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if mosaic:
            ...
            if self.augment:
                image, label = random_perspective(image, label, self.input_size, params)
    ...
    def load_mosaic(self, index, params):
        ...
        # Augment
        image4, label4 = random_perspective(image4, label4, self.input_size, params)
